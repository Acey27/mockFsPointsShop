...
const PointsPage: React.FC = () => {
  ...
  const cheerMutation = useMutation({
    mutationFn: ({ toUserId, amount, message }: { toUserId: string; amount: number; message: string }) =>
  ...
  const getSafeUserInfo = (userRef: any) => {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <select
                ...
                onChange={(e) => setTransactionFilter(e.target.value as 'all' | 'earned' | 'spent')}
              ...
              {(!transactions?.data || transactions.data.length === 0) && (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500 text-sm mb-4">
                    {transactionFilter === 'all' 
                      ? 'Your transaction history will appear here as you earn and spend points'
                      : transactionFilter === 'earned'
